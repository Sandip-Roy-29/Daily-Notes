        ...
        <div className="prose prose-invert max-w-none space-y-6">
          ...
          <section>
            ...
            <ul className="list-disc list-inside text-gray-300 space-y-2 ml-4">
              ...
              <li><strong>Content:</strong> Notes and content you create</li>
              <li><strong>Usage Data:</strong> Log data, device information, IP address</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-300 leading-relaxed">
              Your data is stored securely in encrypted databases. We use industry-standard 
              security measures to protect your information, including HTTPS encryption, 
              secure password hashing, and regular security audits.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-300 leading-relaxed">
              ...
              account, we permanently delete all your personal information and notes within 30 days.
            </p>
          </section>

          <section>
            <h2 className="text-2xl font-semibold text-white mb-3">8. Changes to Privacy Policy</h2>
            <p className="text-gray-300 leading-relaxed">
